...
class HeroSectionController extends Controller
{
    ...
    {
        $hero_sections = hero_section::orderByDesc('id')->paginate(10);
    ...
    public function store(StoreHeroSectionRequest $request)
    {
        ...
        DB::transaction(function () use ($request) {
            ...
            $newDataRecord = hero_section::create($validated);
        });
        

        return redirect()->route('admin.hero_sections.index')->with('success', 'hero section berhasil dibuat!'); 
    }
     ...
     */
    public function update(UpdateHeroSectionRequest $request, hero_section $hero_section)
    {
