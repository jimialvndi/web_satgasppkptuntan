<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can ('manage artikels')
                    <x-nav-link :href="route('admin.artikels.index')" :active="request()->routeIs('admin.artikels.index')">
                        {{ __('Artikels') }}
                    </x-nav-link>
                    @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            {{-- SAMAKAN LINK DI SINI DENGAN YANG ADA DI DESKTOP --}}
            <x-responsive-nav-link :href="route('front.index')" :active="request()->routeIs('front.index')">
                {{ __('Home') }}
            </x-responsive-nav-link>

            @can ('manage hero_sections')
            <x-responsive-nav-link :href="route('admin.hero_sections.index')" :active="request()->routeIs('admin.hero_sections.index')">
                {{ __('Hero Sections') }}
            </x-responsive-nav-link>
            @endcan
            ...
            @can ('manage programs')
            <x-responsive-nav-link :href="route('admin.programs.index')" :active="request()->routeIs('admin.programs.index')">
                {{ __('Programs') }}
            </x-responsive-nav-link>
            @endcan

            @can ('manage artikels')
            <x-responsive-nav-link :href="route('admin.artikels.index')" :active="request()->routeIs('admin.artikels.index')">
                {{ __('Artikels') }}
            </x-responsive-nav-link>
            @endcan
